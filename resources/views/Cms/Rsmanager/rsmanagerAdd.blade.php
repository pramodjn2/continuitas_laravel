    ...
    <div class="col-md-12 ">
      <div  class="panel panel-default">
        ...
        <div class="panel-body">
          <hr>
          <form method="post" action="{{url('cms/manager/store')}}" role="form" id="form1">
            {{ csrf_field() }}
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" placeholder="{{trans('common.name')}}" class="form-control" id="managerName" name="managerName">
                </div>
                
                <div class="form-group">
                  <label class="control-label"> {{trans('common.email')}} <span class="symbol required">*</span> </label>
                  <input type="text" placeholder="{{trans('common.email')}}" class="form-control" id="email" name="email">
                </div>
...
$(document).ready(function() {
				...
				ignore: "",
		            ...
		            messages: {
		                ...
		                email: {
		                    required: {{trans('commit.thisFieldRequired')}},
