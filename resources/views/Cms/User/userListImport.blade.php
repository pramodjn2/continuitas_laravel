    ...
    <div class="col-md-12 ">
      <div  class="panel panel-default">
        ...
        <div class="panel-body">
          <hr>
          <form action="{{url('cms/user/importCSV')}}" enctype="multipart/form-data" method="POST" >
            {{ csrf_field() }}
            <div class="row">
      ...
      <div class="col-md-12">
          ...
          <div class="col-md-8">
            <div class="form-group">
              ...
              <div class="col-md-8">  
                <input type="file" id="userfile" name="userfile" class="form-control input-large" >
            ...
            <div class="row">
              <div class="col-md-6">
                <div> <div class="alert alert-info">
                  ...
                  <b><a  href="{{url('cms/user/sample')}}">{{trans('common.here')}}</a></b>
                </div>
                  <hr>
                </div>
              </div>
