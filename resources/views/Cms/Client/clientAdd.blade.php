    ...
    <div class="col-md-12 ">
      <div  class="panel panel-default">
        ...
        <div class="panel-body">
          <hr>
          <form method="post" action="{{url('cms/client/store')}}" role="form" id="form1">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="{{trans('common.firstName')}}" class="form-control" id="username" name="username">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" placeholder="{{trans('common.initials')}}" class="form-control" id="initials" name="initials">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label class="control-label">{{trans('common.telephoneNumber')}} <span class="symbol required">*</span> </label>
                  <input type="number" placeholder="{{trans('common.telephoneNumber')}}" class="form-control" name="telephone" id="telephone">
                </div>
                <div class="form-group">
		        ...
		        form.validate({
		            ...
		            messages: { 
		                ...
		                email: {
		                    ...
		                    email: "Uw e-mailadres moet in het formaat van name@domain.com"
		                },
