    ...
    <div class="col-md-12 ">
      <div  class="panel panel-default">
        ...
        <div class="panel-body">
          <hr>
          <form method="post" action="{{url('cms/role/store')}}" role="form" id="form1">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="{{trans('common.roleName')}}" class="form-control" id="name" name="name">
                </div>
                <div class="form-group">
                  <label class="control-label"> {{trans('common.label')}}<span class="symbol required">*</span> </label>
                  <input type="text" placeholder="{{trans('common.label')}}" class="form-control" id="label" name="label">
                </div>
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-2"> <a href="{{url('cms/user')}}" class="btn btn-success btn-block" >{{trans('common.back')}} <i class="fa fa-arrow-circle-left"></i></a> </div>
              <div class="col-md-3">
